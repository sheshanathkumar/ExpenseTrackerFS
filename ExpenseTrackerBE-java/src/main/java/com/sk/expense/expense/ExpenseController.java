...
public class ExpenseController {
    ...
    private String getFileName () {
        ...
        String fileName = monthArr[date.getDayOfMonth()] ;
    ...
    public ResponseEntity<List<Transaction>> addTransaction( @RequestBody Transaction transaction) throws IOException {
